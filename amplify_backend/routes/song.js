...
// Get route to get all songs any artist has pusblished
...
router.get(
  ...
  async (req, res) => {
    ...
    // ![] = false //--> here if we were passing any non existent user so it was returning empty array and was not going into the error condn. Therefore we did find -> findOne above
    // !NULL = true
    // !undefined = true
    if (!artist) {
