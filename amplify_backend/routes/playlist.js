...
// We will get the playlist Id as route parameter and we will return the playlist having that ID
router.get(
...
router.get(
  ...
  async (req, res) => {
    ...
    // Check if artist with the given artist Id exisits
...
router.post(
  ...
  async (req, res) => {
    ...
    //--> doing != below will compare the types of both the ids and since it is object we cant compare objects directly in JS so 'equals' actually compares the value of both the ids
    if (
    ...
    // Step 4: We can now simply add the song to the playlist
